...
<body>
	...
	<nav class="site-nav">
		<div class="container-fluid">
			<div class="site-navigation">
				<a href="#" class="logo m-0 float-start">Archiark<span class="text-primary">.</span> </a>
  ...
  <section class="stats">
    <div class="stat-box">
      <div class="number" data-target="3000" data-suffix="+">0+</div>
      <div class="label">Lulusan terbaik</div>
    </div>

    <div class="stat-box">
      <div class="number" data-target="90" data-suffix="%">0%</div>
      <div class="label">Telah bekerja</div>
    </div>

    <div class="stat-box">
      <div class="number" data-target="100" data-suffix="+">0+</div>
      <div class="label">Dunia industri</div>
    </div>

    <div class="stat-box">
      <div class="number" data-target="300" data-suffix="+">0+</div>
      <div class="label">Kuliah di PTN</div>
    </div>
  </section>

  <div class="motto-box">
    <strong>MOTO SMPN 2 DAYEUHKOLOT	</strong>
  ...
  <script>
    document.querySelectorAll('.number').forEach(counter => {
      ...
      const update = () => {
        ...
        if (current < target) {
          counter.innerText = (current + step) + suffix;
